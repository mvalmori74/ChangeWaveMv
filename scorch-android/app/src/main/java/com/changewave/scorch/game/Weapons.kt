...
object Weapons {
    ...
    private val FUNKY_CHILD = Weapon(
        ...
        radius = 36f, damage = 13f, cost = 0, packSize = 0,
    ...
    private val MIRV_CHILD = Weapon(
        ...
        radius = 43f, damage = 19f, cost = 0, packSize = 0,
    ...
    val MIRV = Weapon(
        ...
        radius = 28f, damage = 0f, cost = 6_000, packSize = 2,
